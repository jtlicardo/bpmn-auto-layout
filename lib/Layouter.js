...
export class Layouter {
  ...
  handleCollaboration(collaboration) {
    ...
    collaboration.participants.forEach((participant) => {
      ...
      const offsetX = POOL_PADDING + POOL_LABEL_WIDTH + 100; // 100px left margin
      const offsetY = verticalCursor + POOL_PADDING;
      ...
      const poolWidth = areaWidth + 2 * POOL_PADDING + POOL_LABEL_WIDTH;
      const poolHeight =
        Math.max(
