export class Grid {
  ...
  add(element, position) {
    ...
    this.setLastElementForLane(element.__laneIndex, element);
  }
  ...
  addAfter(element, newElement) {
    ...
    this.setLastElementForLane(newElement.__laneIndex, newElement);
  }
  ...
  setLastElementForLane(laneIdx, el) {
    if (laneIdx === undefined || laneIdx === null) return;
    this.lastElementByLane[laneIdx] = el;
  }

  getLastElementForLane(laneIdx) {
    return this.lastElementByLane[laneIdx];
  }
}