...
// horizontal label stripe on the very left
export const POOL_LABEL_WIDTH = 40;
export const LANE_LABEL_WIDTH = 30;

// white-space between pool border <--> first grid cell
export const POOL_PADDING = 20;

// white-space between two pools
export const POOL_SPACING = 50;
...
/**
 * Helper that translates every coordinate of a BPMNDI element.
 */
export function translateDi(di, { dx = 0, dy = 0 }) {
  if (di.bounds) {
    di.bounds.x += dx;
    di.bounds.y += dy;
  }
